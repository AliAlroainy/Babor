                ...
                <div class="card-body dashboard-tabs p-0">
                    <ul class="nav nav-tabs px-4" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class=" nav-link {{ request()->is('user/auctions/subscribed_auction') ? 'active' : null }}"
                                id="{{ route('user.show.subscribed.auction') }}-tab" href="{{ route('user.show.subscribed.auction') }}"
                                role="tab">
                    ...
                    <div class="tab-content py-0 px-0">
                        <div class="tab-pane fade {{ request()->is('user/auctions/current_auction') ? 'show active' : null }}"
                            ...
                            <div class="tab-pane fade {{ request()->is('user/auctions/ended_auction') ? 'show active' : null }}"
                                id="{{ route('user.show.ended.auction') }}" role="tabpanel" aria-labelledby="{{ route('user.show.ended.auction') }}-tab">
                            ...
                            <div class="tab-pane fade {{ request()->is('user/auctions/subscribed_auction') ? 'show active' : null }}"
                                id="{{ route('user.show.subscribed.auction') }}" role="tabpanel" aria-labelledby="{{ route('user.show.subscribed.auction') }}-tab">
