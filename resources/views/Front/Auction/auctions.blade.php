                                            ...
                                            <div class=" p-2 bg-white d-flex flex-column shadow rounded">
                                                <div class="mt-1 text-center">
                                                    <img class="img-fluid img-responsive rounded product-image"
                                                        src="/images/cars/{{ $auction->car->thumbnail }}" alt="car image"
                                                        width="100">
                                                </div>
                                                ...
                                                <div class="mt-auto row align-items-baseline justify-content-evenly">
                                                    ...
                                                    @else
                                                        <button style="width: fit-content"
                                                            ...
                                                            data-bs-toggle="modal">
                                                            تمديد الوقت
                                                            <i class="fas fa-expand-alt pe-2" style="font-size: 12px ;"></i>
                                                        </button>
                                ...
                                <div class="row  ">
                                    <div class="col-lg-12 grid-margin stretch-card" style="width: 100%">
                                        <div class="cardp d-flex align-items-center justify-content-center">
                                            <div class="card-body d-flex  align-items-center justify-content-center">
                                                <h1 style="margin-top:-40px">
                                                    <i class="bi bi-hourglass-split ms-2"></i> مزادات بانتظار موافقة
                                                    المسؤول
                                                </h1>
                                            </div>
                                        </div>
                                            ...
                                            <div class=" p-2 bg-white d-flex flex-column shadow rounded">
                                                ...
                                                <div class="mt-3 row align-items-baseline justify-content-evenly">
                                                    <div class="col-12 col-sm-5">
                                                        <p>
                                                            <i class="fas fa-hourglass-start"></i>
                                                            <span class="fw-bold">تاريخ الرفض</span>
                                                            <br>
                                                            <span class="ps-1 pe-3">
                                                                {{ $auction->startDate }}
                                                            </span>
