                        ...
                        <div class="col-md-12 mx-0">
                            <form class="msform" action="{{ route('user.save.auction') }}" method="POST"
                                ...
                                <div>
                                    <div class="form-card text-center row">
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="minInc" placeholder="$200"
                                                class="bg-transparent input dark-placeholder form-control"
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="reservePrice" placeholder="$7000"
                                ...
                                <div>
                                    <div class="form-card text-center row">
                                        ...
                                        <div
                                            ...
                                            <input type="text" class="bg-transparent input dark-placeholder form-control"
                                                placeholder="2020" name="model"
                                                value="{{ old('model', $car->model ?? null) }}" placeholder="مثال 2013">
                                            @error('model')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div
                                            ...
                                            @error('numberOfKillos')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>

                                        <div
                                            class="col-12 col-md-3 mb-4 d-flex flex-column justify-content-center align-items-start">
                                            <p>
                                    ...
                                    <div class="d-flex">
                                        <input type="submit" class="btn btn-warning w-75 fw-bold ms-2"
                                            value="اضافة الى المزاد" />
