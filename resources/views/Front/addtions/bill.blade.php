...
<div class="container mt-3 d-flex flex-column align-items-center justify-content-center w-100">
    ...
    <div bgcolor="#f6f6f6" style="color: #333; height: 100%; width: 100%;" height="100%" width="100%">
        <table dir="rtl" bgcolor="#f6f6f6" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding: 0;">
                                        <a href="/" style="color: #348eda;" target="_blank">
                                            <img src="/assets/images/logo.png" alt="babor.com"
                                                style=" max-width: 100%; width: 150px;" width="150" />
                                        </a>
                                    </td>
                                    <td style="color: #999; font-size: 12px; padding: 0; text-align: right;"
                                        align="right">
                                        بابور<br />
                                        رقم الفاتورة: #{{ $bill->invoice_reference }}<br />
                                        {{ $bill->created_at }}
                                    </td>
                                </tr>
                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td align="right" style="padding: 5px 0;">
                                                        اللون
                                                        {{ $bill->bid->auction->car->color }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 5px 0;">حالة السيارة</td>
                                                    <td align="right" style="padding: 5px 0;">
                                                        {{ \App\Models\Car::getStatus($bill->bid->auction->car->status) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    <td width="40%" valign="top" style="padding: 10px 0;">
                                        ...
                                        <p
                                            ...
                                            يرجى مراجعة
                                            <a href="/contact" style="color: rgb(221, 140, 11);" target="_blank">
                                                الدعم الفني
                                            </a>
                                            بأي اسئلة.
                                        </p>
                                    ...
                                    <td width="40%" valign="top" style="padding: 10px 0;">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <lottie-player src="https://assets8.lottiefiles.com/temp/lf20_xG4aYa.json"
                                                background="transparent" speed="0.5" style="width: 80px; height: 80px;"
