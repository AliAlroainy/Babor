...
{{--            </li>--}}
             ...
             <li class="nav-item me-5"> <a class="nav-link" href="{{route('user.auction')}}" target="_self">عرض المزادات</a></li>
             <li class="nav-item me-5"> <a class="nav-link" href="{{route('user.addAuction')}}">إضافة مزاد</a></li>
             </ul>
             </div>
             </li>
        </ul>
