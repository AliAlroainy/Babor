            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <div class="row box-right me-0 ms-0 w-100">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <p class="p-blue fw-bold"><span class="fas fa-circle pe-2"></span> الأرباح: </p>
                                <p class="fw-bold">
                            ...
                            <div class="d-flex">
                                <p class="p-org fw-bold"><span class="fas fa-circle pe-2"></span> إيداع المزادات: </p>
                                <p class="fw-bold">
                                    <span class="text-muted pe-2">$</span>
                                    {{ $auction_money }}
                                </p>
                            ...
                            <div class="d-flex">
                                <p class="p-org fw-bold"><span class="fas fa-circle pe-2"></span> إيداع المزايدات: </p>
                                <p class="fw-bold">
                                    <span class="text-muted pe-2">$</span>
                                    {{ $bidding_money }}
                                </p>
                            ...
                            <tbody>
                                @for ($tran = 0; $tran < $operations->count(); $tran++)
                                    ...
                                    <tr>
                                        ...
                                        @elseif (isset($operations[$tran]->meta['sell']))
                                            <td>بيع المزاد</td>
