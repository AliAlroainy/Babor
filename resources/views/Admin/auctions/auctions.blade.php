                                                ...
                                                <td class="status status_filed" style="text-align:center">
                                                    <form action="{{ route('admin.auction.action', $auction->id) }}"
                                                        ...
                                                        <div style="display:flex;flex-direction:row">
                                                            <button type="submit" name="approve" style="width: fit-content; font-size: 30px ;color:#71c016;align:center"
                                                        class="btn d-flex align-items-center
                                                               font-weight-inverse-success
                                                              btn-rounded  fa-solid  fa-circle-check pe-2"  value="موافقة"></button>
                                         ...
                                         @foreach ($auctions as $auction)
                                             <tr
                                                 ...
                                                 <div class="  ">
                                                     ...
                                                     <td style="text-align:center">
                                                         <a href="{{ route('admin.auction.details', $auction->id) }}"
                                                             class="btn btn-inverse-warning btn-fw btn-rounded text-inverse-white"
                                                             style="font-size:12px"> عرض المزيد
                                                         </a>
                                                     </td>
                                                     <td class="status status_filed" style="text-align:center">
