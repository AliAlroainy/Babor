                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="border-radius: 3px;" class="text-center bg-secondary-color"><a
                                                        href="https://mail.google.com/mail/u/0/" target="_blank"
                                                        style="font-size: 20px; text-decoration: none; padding: 15px 25px; border-radius: 2px;  display: inline-block; color: #fff">تاكيد
                                                        الحساب</a></td>
                                            </tr>
                                        </table>
                                    </td>
