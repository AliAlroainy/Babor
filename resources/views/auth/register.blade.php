                                ...
                                <form class="pt-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg"
                                            id="exampleInputUsername1" name="username" placeholder="أسم المستخدم">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-lg"
                                            id="exampleInputPassword1" name="repassowrd"
                                    ...
                                    <div class="mt-3">
                                        <a class="btn btn-inverse-primary btn-fw btn-rounded fs-5 fw-bold" href="">إنشاء
                                            حساب</a>
                                    </div>
                                    <div class="text-center mt-4 font-weight-light">
