        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder=" بريدك الالكتروني">
                </div>
                <div class="form-group">
                  <input type="password" name="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="كلمة المرور">
                </div>
                <div class="mt-3">
                  <a class="btn btn-inverse-success btn-fw btn-rounded" href="">تسجيل الدخول</a>
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center">
                  <div class="form-check">
                      <input type="checkbox" class="form-check-input " id="rememberMe">
                    <label class="form-check-label text-muted"  style="margin-left: 0.5rem" for="rememberMe">
                      تذكرني
                    </label>
                  </div>
                ...
                <div class="text-center mt-4 font-weight-light">
                    ليس لديك حساب ؟
                    <a href="register.html" class="text-primary">انشئ حسابك</a>
                </div>
              </form>
            </div>
          </div>
