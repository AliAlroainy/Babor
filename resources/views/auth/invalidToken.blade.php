                ...
                <table border="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; font-family: tajawal;">خطأ</h1> <img
                                src=" {{ @asset('assets/images/auth/error.jpg') }}" width="125" height="120"
                            ...
                            <table>
                                <tr>
                                    <td bgcolor="#ffffff" align="center" style="padding: 20px 30px 60px 30px;">
                                        <table>
                                            <tr>
                                                <td style="border-radius: 3px;" class="text-center bg-secondary-color"><a
                                                        href="" target="_blank"
                                                        style="font-size: 20px; text-decoration: none; padding: 15px 25px; border-radius: 2px;  display: inline-block; color: #fff">العودة
                                                        للخلف</a></td>
                                            </tr>
                                        </table>
                                    </td>
